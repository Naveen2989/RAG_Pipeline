...
# Ollama LLM configuration - llama3.1:latest
config_list = [
    {
        "model": "llama3.1:latest",  # Use Ollama Llama3.1:latest model
...
# Define Location Detail Function -     
@dataclass
class LocationInfo:
    weather: str
    events: List[str]
...
# TravelTools Class with static methods    
class TravelTools:
    @staticmethod
...
#Create TravelAgentSystem Class - Create Agents
